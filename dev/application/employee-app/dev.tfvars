...
vpc_state_key    = "dev/application/employee-api/vpc.tfstate"

# ALB Terraform state
alb_state_bucket = "dev-otms-terraform-state"
alb_state_key    = "dev/application/employee-api/alb.tfstate"

# Frontend Terraform state
frontend_state_bucket = "dev-otms-terraform-state"
frontend_state_key    = "dev/application/employee-api/frontend.tfstate"
